...
public class OthelloMVCSetup {
	...
	public OthelloMVCSetup(int boardSize){
		...
		load.addActionListener(new LoadListener(model,testFrame));
		JButton undo = new JButton("UNDO");
		undo.addActionListener(new UndoListener(model,testFrame));
		...
		constraints.gridx = 0;
		constraints.gridy= 1;
		gameOptionPanel.add(save,constraints);
		constraints.weightx = 0.1;
		constraints.weighty = 0.1;
		constraints.gridx = 0;
		constraints.gridy= 2;
		gameOptionPanel.add(load,constraints);
		constraints.weightx = 0.1;
		constraints.weighty = 0.1;
		constraints.gridx = 2;
		constraints.gridy= 1;
		gameOptionPanel.add(undo,constraints);
		constraints.weightx = 0.1;
		constraints.weighty = 0.1;
		constraints.gridx = 2;
		constraints.gridy= 2;
		gameOptionPanel.add(redo,constraints);
