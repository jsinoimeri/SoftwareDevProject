...
public class Human implements Player, java.io.Serializable
{
	...
	private static final String NAME = "Human",
	                            ...
	                            SELECTROW = "Enter an integer for row or enter -1 for help, -2 for redo, -3 for undo, -4 for save game, -5 for load game: ",
			                    SELECTCOL = "Enter an integer for column or enter -1 for help, -2 for redo, -3 for undo, -4 for save game, -5 for load game: ";
	
	
	
	private transient Scanner scanner;                 // scanner instance for input
